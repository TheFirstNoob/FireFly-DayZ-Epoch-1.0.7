building_catalog =
{
	...
	{
		"Вы не можете открыть меню в бою." call dayz_rollingMessages;
	};

	if (!(isNull (findDisplay 7121197))) exitwith
	{
		closeDialog 0;
	};
...
building_previews =
{
	...
	format ["Загрузка данных о %1.", _class] call dayz_rollingMessages;
	local _recipe 		= 	[];
	local _stats 		= 	[];
	
	local _formatedText = 	"
	<br/>
	<t size='0.8' font='Zeppelin33' align='center' color='#b00000'>Требуется для создания:</t><br/>
	<t size='0.7' font='Zeppelin33' align='center' color='#ffffff'>%1</t><br />
	<t size='0.8' font='Zeppelin33' align='center' color='#b00000'>Нужно еще: </t><br/>
	<t size='0.7' font='Zeppelin33' align='center' color='#ffffff'>%2</t>
	";
	...
	local _fnc_getName =
	{
...

		{
			...
			{
				getText (configFile >> _x >> _this >> "displayName")
			};
			_this
	...
	for "_i" from 0 to (count _cfgmags)-1 do {
		...
		for "_i" from 1 to 7 do {
			...
			_actions set [count _actions, "Crafting" + str _i];
		};
