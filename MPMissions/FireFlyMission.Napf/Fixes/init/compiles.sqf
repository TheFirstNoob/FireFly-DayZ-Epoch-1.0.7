...
if (!isDedicated) then {
	...
	player_attackdelay = compile preprocessFileLineNumbers "Fixes\compile\player_attackfsmdelay.sqf";
	fnc_usec_damageActions = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector = compile preprocessFileLineNumbers "Fixes\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions = compile preprocessFileLineNumbers "Fixes\init\fn_selfActions.sqf";		//Checks which actions for self
	...
	player_music = compile preprocessFileLineNumbers "Fixes\compile\player_music.sqf";			//Used to generate ambient music
	...
	world_sunRise = compile preprocessFileLineNumbers "Fixes\compile\fn_sunRise.sqf";
	world_surfaceNoise = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_surfaceNoise.sqf";
	player_humanityMorph = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_humanityMorph.sqf";
	player_throwObject = compile preprocessFileLineNumbers "Fixes\compile\player_throwObject.sqf";
	...
	player_emptyContainer = compile preprocessFileLineNumbers "Fixes\actions\player_emptyContainer.sqf";
	...
	player_gearSet = compile preprocessFileLineNumbers "Fixes\compile\player_gearSet.sqf";
	...
	player_lockVault = compile preprocessFileLineNumbers "Fixes\compile\player_lockVault.sqf";
	...
	player_unlockVault = compile preprocessFileLineNumbers "Fixes\compile\player_unlockVault.sqf";
	...
	*/
	...
	DZ_KeyDown_EH = compile preprocessFileLineNumbers "Fixes\compile\keyboard.sqf";
