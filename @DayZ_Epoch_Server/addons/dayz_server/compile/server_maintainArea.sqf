...
if (_option == 1) then
{
	...
	diag_log format ["[СЕРВЕР]: [server_maintainArea.sqf]: [MAINTAIN AREA]: Игрок: %1 - %2. Объектов: %3, Позиция: %4", _name, (count _objectsInfo), (getPosATL _player), mapGridPosition(getPosATL _player)];
}
else
{
