...
if (_debug) then {_AH_Global = _AH_Global + ("
	_queue set [count _queue, [{
		...
		local _txt = format[""<t size='1' font='Bitstream' align='center'>%1</t><br/>"", name player];
		_txt = _txt + format[""<t size='1' font='Bitstream' align='left'>Игроков онлайн: </t><t size='1' font='Bitstream' align='right'>%1</t><br/>"", count playableUnits];
		_txt = _txt + format[""<t size='1' font='Bitstream' align='left' color='#FF0000'>Кровь: </t><t size='1' font='Bitstream' align='right' color='#FF0000'>%1</t><br/>"", [r_player_blood] call BIS_fnc_numberText];
		_txt = _txt + format[""<t size='1' font='Bitstream' align='left' color='%1'>Репутация: </t><t size='1' font='Bitstream' align='right' color='%1'>%2</t><br/><br/>"", _humanity, [[player, 'humanity', 0] call "+_kfc_gvar+"] call BIS_fnc_numberText];
		_txt = _txt + format[""<t size='1' font='Bitstream' align='left'>FPS: </t><t size='1' font='Bitstream' align='right'>%1</t><br/>"", round diag_fps];
		_txt = _txt + format[""<t size='1' font='Bitstream' align='left'>Рестарт через: </t><t size='1' font='Bitstream' align='right'>%1ч %2мин</t><br/>"", _hours, _minutes];
		_txt = _txt + ""<t size='1' font='Bitstream' align='center' color='#FFBF00'>"+_dtext+"</t>"";
